#ifndef __ASYNC_URDL_DETAIL_HTTP_READ_STREAM_HPP
#define __ASYNC_URDL_DETAIL_HTTP_READ_STREAM_HPP
...
namespace urdl
{
	namespace detail 
	{
		...
		public:
			...
			{
				open_coro<HandlerT>(handler, resolver_, socket_, options_, request_buffer_,
